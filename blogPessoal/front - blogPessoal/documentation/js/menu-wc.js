                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-0ef0903d8c40c01dc84c720bee064d0a"' : 'data-target="#xs-components-links-module-AppModule-0ef0903d8c40c01dc84c720bee064d0a"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-0ef0903d8c40c01dc84c720bee064d0a"' :
                                            'id="xs-components-links-module-AppModule-0ef0903d8c40c01dc84c720bee064d0a"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/PicturesComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">PicturesComponent</a>
                                            </li>
                                            <li class="link">
